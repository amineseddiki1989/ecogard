...
@NoArgsConstructor
@AllArgsConstructor
public class AnonymousReportDTO {

    @NotBlank(message = "Device partition UUID is required")
    private String devicePartitionUuid;
    ...
    // Validation signature to prevent fake reports
